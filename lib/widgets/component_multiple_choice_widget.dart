...
class ComponentMultipleChoiceWidget extends StatefulWidget {
  late bool isEditMode;
  final int index;
  final VoidCallback? onPressed;

  ComponentMultipleChoiceWidget({
  ...
  @override
  State<ComponentMultipleChoiceWidget> createState() =>
      _ComponentMultipleChoiceWidgetState();
}

class _ComponentMultipleChoiceWidgetState
    extends State<ComponentMultipleChoiceWidget> {
  bool eye = false;
  Icon? icone;
